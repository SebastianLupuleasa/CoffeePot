...
-- Espressso
 ...
 insert into coffee values(990,'espresso fast','images/espresso.png','espresso',0.5,990,990);
...
insert into coffee values(991,'machiatto is good','images/machiatto.png','machiatto',0.7,990,991);
...
insert into coffee values(992,'coffee latte i see','images/coffeelatte.png','coffee latte',1,990,992);
...
insert into coffee values(993,'cappucino lalacino','images/cappucino.png','cappucino',1,990,993);
...
insert into coffee values(994,'coffee miel','images/coffeemiel.png','coffee miel',1.3,990,994);
